...
.border0 a:hover{
  ...
  <%
   ...
   <form name="form1" method="post" action="admin/input/input_recommend.jsp"> 
				<%
   while(res.next()==true){
   %>
    <tr>
    ...
    <label><%=res.getString("name")%></label>
				...
				<td><a href="admin/delete/delete_recommend.jsp?id=<%=res.getString("name")%>">删除操作</a></td><td><a href="admin/update/update_recommend.jsp?id=<%=res.getString("name")%>">更新操作</a></td></tr>
				...
				<%
				 ...
				 <tr><th colspan="8">
              <a href="admin/input/input_recommend.jsp" >插入</a>
   	        </tr>	
			</form>
