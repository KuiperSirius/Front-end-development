  ...
  <%
   ...
   %>
    ...
    <label><%=res.getString("name")%></label>
				...
				<td><a href="admin/delete/delete_movie.jsp?id=<%=res.getString("name")%>">删除操作</a></td><td><a href="admin/update/update_movie.jsp?id=<%=res.getString("name")%>">更新操作</a></td></tr>
				<%
				
				} %>
						 <tr><th colspan="8">
              <a href="admin/input/input_movie.jsp" >插入</a>
   	        </tr>			
			</form>
