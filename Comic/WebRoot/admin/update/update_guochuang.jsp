...
<html>
  <head>
    ...
    <title>My JSP 'update_guochuang.jsp' starting page</title>
...
box-shadow:0px 0px 12px 2px green;
  ...
  <body>
 <form action="guochuang" method="post"  enctype="multipart/form-data">
    <table class="border0">
  ...
  //out.print(idName);
   ...
   String sql="select * from guochuang where name=? union select * from movie where name=? union select *from recommend where name=? union select *from riman where name=?";
