...
<html>
  <head>
    ...
    <title>My JSP 'update_riman.jsp' starting page</title>
...
box-shadow:0px 0px 12px 2px green;
 ...
 <body>
 <form action="riman" method="post"  enctype="multipart/form-data">
    <table class="border0">
  ...
  if(res.next()){
   %>
    ...
    <input type="text" class="input-text-shadow" name="changeName"value="<%=res.getString("name")%>">
	           ...
	           <lable>更改</lable>
						<input type="file" name="myfile" value="<%=res.getString("image")%>" size=20/>
				</th>
				<th>
