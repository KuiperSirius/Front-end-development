...
<body>
	...
	<div id="container">
		...
		<form method="POST" action="admin/insert.jsp">
			<div class="combo">
				<div class="font">用户名</div>
				<div class="input-text">
					<input type="text" name="username" class="input-text-shadow">
				</div>
			</div>
			<div class="combo">
				<div class="font">密码</div>
				<div class="input-text">
					<input type="text" name="password" class="input-text-shadow">
				</div>
			</div>
			<div class="combo">
				<div class="font">电子邮件</div>
				<div class="input-text">
					<input type="text" name="password" class="input-text-shadow">
				</div>
			</div>
			...
			<div class="combo">
				<div class="font">签名</div>
				<div class="input-text">
					<input type="text" name="password" class="input-text-shadow">
				</div>
			</div>
			<div class="combo">
				<div class="font">图片</div>
				<div class="input-text">
					<input type="text" name="password" class="input-text-shadow">
				</div>
			</div>
