    ...
    <div id="container">
		...
		<div id="main2">
			<%
				...
				GuoChuang gc = new GuoChuang();
				List<Cartoon> cartoons = gc.getcartoon(pageSize, currentPage);
				maxPage = gc.getmaxPage(totalRow, pageSize);
				...
				if (currentPage == 1) {
					out.print("<a href=main1.jsp?page=" + (currentPage + 1)
							+ ">下一页</a>");
					out.print("<a href=main2.jsp?page=" + maxPage + ">尾页</a>");
				} else if (currentPage < maxPage) {
					out.print("<a href='main2.jsp'>首页</a>");
					out.print("<a href='main2.jsp?page=" + (currentPage - 1)
							+ "'>上一页</a>");
					out.print("<a href=main2.jsp?page=" + (currentPage + 1)
							+ ">下一页</a>");
					out.print("<a href=main2.jsp?page=" + maxPage + ">尾页</a>");
