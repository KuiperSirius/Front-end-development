	...
	<div id="container">
		...
		<div id="main2">
			<%
				...
				RiMan rm = new RiMan();
				List<Cartoon> cartoons = rm.getcartoon(pageSize, currentPage);
				maxPage = rm.getmaxPage(totalRow, pageSize);
				...
				if (currentPage == 1) {
					out.print("<a href=main1.jsp?page=" + (currentPage + 1)
							+ ">下一页</a>");
					out.print("<a href=main1.jsp?page=" + maxPage + ">尾页</a>");
				} else if (currentPage < maxPage) {
					out.print("<a href='main1.jsp'>首页</a>");
					out.print("<a href='main1.jsp?page=" + (currentPage - 1)
							+ "'>上一页</a>");
					out.print("<a href=main1.jsp?page=" + (currentPage + 1)
							+ ">下一页</a>");
