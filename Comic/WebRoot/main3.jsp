...
<html>
  <head>
    ...
    <title>My JSP 'main3.jsp' starting page</title>
    ...
    <div id="container">
		...
		<div id="main2">
			<%
				...
				Movie mo = new Movie();
				List<Cartoon> cartoons = mo.getcartoon(pageSize, currentPage);
				maxPage = mo.getmaxPage(totalRow, pageSize);
				...
				if (currentPage == 1) {
					out.print("<a href=main3.jsp?page=" + (currentPage + 1)
							+ ">下一页</a>");
					out.print("<a href=main3.jsp?page=" + maxPage + ">尾页</a>");
				} else if (currentPage < maxPage) {
					out.print("<a href='main3.jsp'>首页</a>");
					out.print("<a href='main3.jsp?page=" + (currentPage - 1)
							+ "'>上一页</a>");
					out.print("<a href=main3.jsp?page=" + (currentPage + 1)
							+ ">下一页</a>");
